...
#define DRV_I2C_MASTER_INT_SRC_IDX0               		INT_SOURCE_I2C_3_MASTER
#define DRV_I2C_SLAVE_INT_SRC_IDX0                		
#define DRV_I2C_ERR_MX_INT_SRC_IDX0               		INT_SOURCE_I2C_3_ERROR
#define DRV_I2C_INT_VECTOR_IDX0                         INT_VECTOR_I2C3
#define DRV_I2C_ISR_VECTOR_IDX0                         _I2C_3_VECTOR
