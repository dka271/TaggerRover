...
static void _PATHFINDING_Tasks(void);
static void _COMMUNICATION_Tasks(void);
static void _FLAGCAPTURE_Tasks(void);
...
void SYS_Tasks ( void )
{
    ...
    /* Create OS Thread for PATHFINDING Tasks. */
    xTaskCreate((TaskFunction_t) _PATHFINDING_Tasks,
                "PATHFINDING Tasks",
                1024, NULL, 1, NULL);
    ...
    /* Create OS Thread for FLAGCAPTURE Tasks. */
    xTaskCreate((TaskFunction_t) _FLAGCAPTURE_Tasks,
                "FLAGCAPTURE Tasks",
                1024, NULL, 1, NULL);
...
/*******************************************************************************
  Function:
    void _PATHFINDING_Tasks ( void )

  Summary:
    Maintains state machine of PATHFINDING.
*/
...
/*******************************************************************************
  Function:
    void _FLAGCAPTURE_Tasks ( void )

  Summary:
    Maintains state machine of FLAGCAPTURE.
*/
